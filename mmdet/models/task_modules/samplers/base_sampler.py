...
class BaseSampler(metaclass=ABCMeta):
    ...
    def sample(self, assign_result: AssignResult, pred_instances: InstanceData,
        ...
        """
        gt_bboxes = gt_instances.bboxes # 当前模型真实的边界框
        priors = pred_instances.priors  # 候选框（可以是锚框、点框，或者上一阶段预测的边界框），形状为 (n, 4)。
        gt_labels = gt_instances.labels # 当前模型真实的标签
        ...
        pos_inds = pos_inds.unique()  # inds缩写一般表示索引位置 indices
